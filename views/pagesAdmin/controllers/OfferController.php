...
class OfferController
{
    ...
    static public function sendOffer($data,$articles,$date,$email,$name){
        ...
        try {
            ...
            <header>
                ...
                <h2>oferta para intercambiar : '.$data['Mensaje'].'</h2>
            </header>
             <main>
               <section> 
   ...
   /*  static public function sendNotOffer($email,$data)
    ...
    static public function listOffer($item,$value){
        $table='oferta';
        $answer=Offer::showOffer($item,$value,$table);
        return $answer;
    }

    static public function listOfferFive(){
        $table='oferta';
        $answer=Offer::showOfferFive($table);
        return $answer;
    }
